...
subsampling method for logistic regression (Skin Data)
================

# 1. Overview

-   The project ***“Skin Data”*** or ***“RS_OS_MROS_LR_RWS_SkinData”***
    is developed for the purpose fitting multiple models estimated model
...
-   Using **Load_Data.R** and based on the **Q** models of the logistic
...
-   As of now the models are based on the covariates
    *x*<sub>1</sub>, *x*<sub>2</sub>, *x*<sub>3</sub> and their
    respective squared terms making **Q=8**.
