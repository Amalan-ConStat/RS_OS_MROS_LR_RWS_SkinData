...
file.copy(from = here("Non_Identical_r0","Simulation_Setup","Analysis","OSMAC_Model_Free","Results",
                      "OSMAC_MF_output_Full.RData"),
          to = here("Non_Identical_r0","Outputs","OSMAC_Model_Free"),
          overwrite = TRUE)
...
for (j in 1:length(All_Models)) 
{
  ...
  load(here("Non_Identical_r0","Outputs","OSMAC_Model_Free","OSMAC_MF_output_Full.RData"))
