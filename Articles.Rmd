...
{
  theme(axis.text.x = element_text(color = "black",size=15), #, vjust = 0.5
...
Combined_MSE$Covariate<-factor(Combined_MSE$Covariate,
                               levels = c("Data Model: x\u2081, x\u2082, x\u2083",
                                          ...
                                          "Data Model: x\u2081, x\u2082, x\u2083, (x\u2082)\u00B2, (x\u2083)\u00B2",
                                          "Data Model: x\u2081, x\u2082, x\u2083, (x\u2081)\u00B2, (x\u2082)\u00B2, (x\u2083)\u00B2"),
                               labels = c(expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[1]^{2}),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[2]^{2}),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[3]^{2}),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[1]^{2}*", "*X[2]^{2}),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[1]^{2}*", "*X[3]^{2}),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[2]^{2}*", "*X[3]^{2}),
                                          expression("Data Model: "*X[1]*", "*X[2]*", "*X[3]*", "*X[1]^{2}*", "*X[2]^{2}*", "*X[3]^{2})))
...
ggsave(filename = here("Article_Plots","RWA_LR_ALL_SMSE_SkinData.pdf"),
       dpi=300,width = 6*2,height = 6*4,units = "in")
ggsave(filename = here("Article_Plots","RWA_LR_ALL_SMSE_SkinData.eps"),
       device="eps",dpi=300,width = 6*2,height = 6*4,units = "in")
...
ggsave(filename = here("Article_Plots","RWA_LR_ALL_Accuracy_SkinData.pdf"),
       dpi=300,width = 6*2,height = 6*4,units = "in")
ggsave(filename = here("Article_Plots","RWA_LR_ALL_Accuracy_SkinData.eps"),
       device="eps",dpi=300,width = 6*2,height = 6*4,units = "in")
...
ggsave(filename = here("Article_Plots","RWA_LR_SMSE_SkinData.pdf"),
       dpi=300,width = 8,height = 6,units = "in")
ggsave(filename = here("Article_Plots","RWA_LR_SMSE_SkinData.eps"),
...
Combined_Accuracy %>%
  ...
  theme_bw()+guides(colour = guide_legend(nrow = 2))+Theme_special()

ggsave(filename = here("Article_Plots","RWA_LR_Accuracy_SkinData.pdf"),
       dpi=300,width = 8,height = 6,units = "in")
ggsave(filename = here("Article_Plots","RWA_LR_Accuracy_SkinData.eps"),
       device="eps",dpi=300,width = 8,height = 6,units = "in")
...
ggsave(filename = here("Article_Plots","Poster_RWA_LR_SkinData.eps"),
       device="eps",dpi=300,width = 8,height = 6,units = "in")
```
